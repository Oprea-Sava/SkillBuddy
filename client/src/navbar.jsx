    ...
    return (
        <div id="navSection">
            ...
            <nav className="navContainer">
                ...
                {isAuthenticated()? (userData.img? (<img className='profileImg' src={userData.img} alt="" onClick={goToDashboard}/>):(<img className='profileImg' src={placeholder} alt="" onClick={goToDashboard}/>)):<button className="secondary signUp text" onClick={goToSignUp}>Sign up</button>}
            </nav>
